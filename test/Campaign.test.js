...
beforeEach(async () => {
    ...
    [campaignAddress] = await factory.methods.getDeplyedCampaigns().call();
...
describe('Campaigns', () => {
    ...
    it('has caller as the campaign manager', async () => {
        const manager = await campaign.methods.manager().call();
        assert.equal(accounts[0], manager);
    });

    it('allows account to contribute and be marked as approver', async () => {
